    ...
    <div className="max-w-5xl mx-auto max-md:max-w-xl py-4">
      ...
      <div className="grid md:grid-cols-3 gap-8 mt-12">
        <div className="md:col-span-2 space-y-4">
          {
            cartItems?.length
              ? cartItems.map((singleCartItem, index) => <CartTile key={index} singleCartItem={singleCartItem} />)
              : <h1 className="text-2xl font-bold text-center">No items available in the cart.</h1>
          }
        </div>
